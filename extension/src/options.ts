...
const extractTextInput = document.querySelector<HTMLInputElement>("#extractText")!;
...
async function init(): Promise<void> {
  ...
  extractTextInput.checked = settings.extractText;
